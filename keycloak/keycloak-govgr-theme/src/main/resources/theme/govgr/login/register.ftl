...
<@layout.registrationLayout; section>
    ...
    <#elseif section = "form">
        <form id="kc-register-form" class="${properties.kcFormClass!}" action="${url.registrationAction}" method="post">
            ...
            <div class="${properties.kcFormGroupClass!} ${messagesPerField.printIfExists('afm',properties.kcFormGroupErrorClass!)}">
                <div class="${properties.kcLabelWrapperClass!}">
                    <label for="user.attributes.afm" class="${properties.kcLabelClass!}">${msg("afm")}</label>
                </div>
                <div class="${properties.kcInputWrapperClass!}">
                    <input
                            type="text"
                            id="user.attributes.afm"
                            class="${properties.kcInputClass!}"
                            name="user.attributes.afm"
                            value="${(register.formData['user.attributes.afm']!'')}"
                    />
                </div>
            </div>
