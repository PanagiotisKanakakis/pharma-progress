export const locale = {
  ...
  data: {
    ...
    MENU: {
      DASHBOARD: {
        COLLAPSIBLE: 'Πίνακας ελέγχου',
        BADGE: '2',
        ANALYTICS: 'Analytics',
        ECOMMERCE: 'eCommerce',
        RESULTS: 'Αποτελέσματα',
        FORECASTING: 'Προβλέψεις',
        CHARTS: 'Γραφήματα'
      },
      INPUT: {
        DATAENTRY: 'Καταχωρηση συναλλαγων',
        INFO: 'Πληροφοριακα στοιχεια',
      },
      APPS: {
        SECTION: 'Apps & Pages',
        INCOME: 'Πωλήσεις',
        INCOME_Z: 'Εισπράξεις Ζ',
        INCOME_REAL: 'Πραγμ. Εισπράξεις',
        EXPENSES: 'Αγορές',
        ...
        OPERATING_EXPENSES: 'Λειτουργικά έξοδα',
