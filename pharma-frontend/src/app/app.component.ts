...
import {locale as menuGreek} from 'app/menu/i18n/gr';
...
export class AppComponent implements OnInit, OnDestroy {
    coreConfig: any;
    menu: any;
    defaultLanguage: 'gr'; // This language will be used as a fallback when a translation isn't found in the current language
    appLanguage: 'gr'; // Set application default language i.e fr
    ...
    constructor(
        ...
        this._translateService.addLangs(['gr']);

        // This language will be used as a fallback when a translation isn't found in the current language
        this._translateService.setDefaultLang('gr');

        // Set the translations for the menu
        this._coreTranslationService.translate(menuGreek);
    ...
    ngOnInit(): void {
        ...
        this._coreConfigService.config.pipe(takeUntil(this._unsubscribeAll)).subscribe(config => {
            ...
            const appLanguage = /*this.coreConfig.app.appLanguage ||*/ 'gr';
